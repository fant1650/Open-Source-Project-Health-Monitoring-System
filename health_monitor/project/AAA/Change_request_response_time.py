...
class ChangeRequestResponseTimeProcessor:
    """处理活动数据，计算索引并存储结果"""
    ...
    def process_files_in_folder(self, folder_path, folder_name):
        ...
        for filename in os.listdir(folder_path):
            ...
            if os.path.isdir(file_path):
                continue  # 忽略子文件夹
            elif filename == 'change_request_response_time.json':  # 找到目标文件
...
def main():
    ...
    processor = ChangeRequestResponseTimeProcessor(root_folder)
